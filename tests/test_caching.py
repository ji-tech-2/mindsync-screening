"""
Unit tests for caching functionality (weekly critical factors,
weekly chart, daily suggestions)
"""
    ...
    def test_weekly_critical_factors_to_dict(self, app, sample_user_id):
        ...
        with app.app_context():
            ...
            record = WeeklyCriticalFactors(
                ...
                total_predictions=10,
                top_factors=[
                    {"factor_name": "Sleep", "count": 5, "avg_impact_score": 2.5}
                ],
    ...
    def test_create_weekly_chart_data(self, app, sample_user_id):
        ...
        with app.app_context():
            ...
            chart_data = [
                ...
                {
                    "date": str(week_start + timedelta(days=1)),
                    "mental_health_index": 80.0,
                    "has_data": True,
                },
            ]
